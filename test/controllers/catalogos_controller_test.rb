...
class CatalogosControllerTest < ActionController::TestCase
  ...
  test "should create catalogo" do
    assert_difference('Catalogo.count') do
      post :create, catalogo: { nome: @catalogo.nome, tipo_id: @catalogo.tipo_id, usuario_id: @catalogo.usuario_id }
    end
  ...
  test "should update catalogo" do
    patch :update, id: @catalogo, catalogo: { nome: @catalogo.nome, tipo_id: @catalogo.tipo_id, usuario_id: @catalogo.usuario_id }
    assert_redirected_to catalogo_path(assigns(:catalogo))
  end
